...
export default function Theme() {
    ...
    window.matchMedia('(prefers-color-scheme: dark').addEventListener('change', (e)=>{
        ...
        //     document.documentElement.classList.remove('dark')
        // }
        // if (e.matches) {console.log('dark')}
        // if (!e.matches) {console.log('light')}
    ...
    return (
        <>
            <div className="dark:text-gray-100 dark:bg-slate-900 min-h-screen p-10 ">
                <div className="fixed top-5 right-10 dark:bg-slate-700 bg-gray-100 rounded-lg p-2 flex justify-betewwn">
                    <button
                    ...
                    className={`${theme==='light'&&'text-sky-600'} px-2`}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
